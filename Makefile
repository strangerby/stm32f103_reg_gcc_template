##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.4.0] date: [Tue Oct 15 20:28:24 CST 2019]
##########################################################################################################################
...
# clean up
#######################################
.PHONY: clean cleanall stm32flash
clean: 
	-rm -fR $(BUILD_DIR)
...
stm32flash :
	stm32flash -w $(TARGET).hex -v -g 0x0 /dev/ttyUSB0
#######################################
# dependencies
#######################################
